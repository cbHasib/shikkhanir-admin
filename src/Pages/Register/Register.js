          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span className="text-2xl font-bold">
                Shikkha<span className="text-purple-600">Nir</span>
              </span>
            </Link>
          </div>
          <div className="mt-6 rounded-3xl border bg-gray-50 dark:border-gray-700 dark:bg-gray-800 -mx-6 sm:-mx-10 p-6 sm:px-10 sm:py-6">
